...
stats %>%
  ...
  geom_smooth(size = 2)+
  theme_minimal()
# Interesting, the oscillations seem to dampen as time goes on. That makes sense. I think I've created solid baseline dynamics!
```

### Allow isolated nodes--does behavior change?
```{r}
