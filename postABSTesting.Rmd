...
plot(singletonClusters ~ isolatedNodes, type = "l") # okay yeah, there's a perfect relationship between these. This tells us that there are no cases in which we get a cluster of size 1 that is NOT an isolated node.
```
