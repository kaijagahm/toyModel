...
mod10 = -0.2
mod11 = 0.4
coefGain = 0.5 # next step is to make these effects depend on the sociability and current situation of the individual.
coefKeep = -0.5
```
...
# yes, we definitely see some individual differences in degree over time. The strenght of this effect depends on socAlpha and socBeta.
```
...
There's no overall pattern to the effect of loss or rewiring on the network. Presumably, if loss or rewiring does have an effect, the extent of the effect will depend on which individuals were removed.
