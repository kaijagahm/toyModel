...
First, I run the model 1000 times and compute the network measures for each of the model runs.

```{r echo = FALSE}
# Run 1000 times, using the parameters defined at the very beginning of this document.
nRuns <- 1000
