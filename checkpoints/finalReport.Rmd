...
2. How does a social network rewire following the loss of multiple nodes? (XXX i.e. which hypothesis? But don't want to actually lay out the hypotheses yet because I'm not testing them yet, right?)

# Methods

## Creating the model
overview of how i decided to approach the model
